...
module.exports = msgHandler = async (client, message) => {
    try {
        ...
        const adminNumber = ['6282301826966@c.us']
        const isAdmin = adminNumber.includes(sender.id)
        const ownerNumber = '6282301826966@c.us'
        ...
        const vhtearkey = '*AཽLཽIཽCཽEཽ*2k99KKYli' // https://api.vhtear.com
                ...
                if (isGroupMsg && isDetectorBadword && !isGroupAdmins && !isPrem && !isOwner){
                    if (chats.match("anjing") || chats.match("gblk") || chats.match("tolol") || chats.match("kntl")) {
                        if (!isGroupAdmins) {
                            ...
                            }).catch(() => client.sendText(from, `Untung *AཽLཽIཽCཽEཽ* Bukan Admin, Kalo Jadi Admin Udah Aku Kick Tuh! 😑`))
                        } else {
        ...
        case '#antibadword':
            ...
            if (args[1] == 'enable') {
                ...
                if(cek){
                    return client.reply(from, `*「 ANTI BADWORD 」*\nPerhatian Untuk Member Grup ${name} Tercinta\nHarap Jangan Toxic Di Sini Atau *AཽLཽIཽCཽEཽ* Akan Kick!`, id)
                } else {
        ...
        case '#addprem':
            if (!isdaftar) return client.reply(from, `*NOMOR KAMU BELUM TERDAFTAR DI *AཽLཽIཽCཽEཽ** \n\n*SILAHKAN LAKUKAN PENDAFTARAN DENGAN CARA KETIK* \n\n#daftar nomor|nama|umur \n\nCONTOH : \n\n#daftar 6282301826966|*AཽLཽIཽCཽEཽ*|17 \n\n*_PENULISAN NOMOR HARUS MENGGUNAKAN 62812XXXXX_*`, id)
            if (!isOwner) return client.reply(from, 'Perintah ini hanya bisa di gunakan oleh Owner *AཽLཽIཽCཽEཽ*!', id)
        ...
        case '#afk':
                ...
                //if (!isOwner) return client.reply(from, 'Maaf, perintah ini hanya dapat dilakukan oleh user owner *AཽLཽIཽCཽEཽ*', id)
...
${desc}`)
        ...
        case '#ims':
            if (isLimit(serial)) return client.reply(from, `${ubah}Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik #limit Untuk Mengecek Kuota Limit Kamu${ubah}`, id)
            if (args.length == 1) return client.reply(from, `kirim dengan\n\nPenggunaan: #ims *AཽLཽIཽCཽEཽ*|bot`, id)
            client.reply(from, '[WAIT] Sedang di proses⏳ silahkan tunggu ± 1 min!', id)
        ...
        case '#imr':
            if (isLimit(serial)) return client.reply(from, `${ubah}Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik #limit Untuk Mengecek Kuota Limit Kamu${ubah}`, id)
            if (args.length == 1) return client.reply(from, `kirim dengan\n\nPenggunaan: #imr *AཽLཽIཽCཽEཽ*|bot`, id)
            client.reply(from, '[WAIT] Sedang di proses⏳ silahkan tunggu ± 1 min!', id)
        ...
        case '#img':
            if (isLimit(serial)) return client.reply(from, `${ubah}Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik #limit Untuk Mengecek Kuota Limit Kamu${ubah}`, id)
            if (args.length == 1) return client.reply(from, `kirim dengan\n\nPenggunaan: #img *AཽLཽIཽCཽEཽ*|bot`, id)
            client.reply(from, '[WAIT] Sedang di proses⏳ silahkan tunggu ± 1 min!', id)
        ...
        case '#irg':
            if (isLimit(serial)) return client.reply(from, `${ubah}Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik #limit Untuk Mengecek Kuota Limit Kamu${ubah}`, id)
            if (args.length == 1) return client.reply(from, `kirim dengan\n\nPenggunaan: #irg *AཽLཽIཽCཽEཽ*|bot`, id)
            client.reply(from, '[WAIT] Sedang di proses⏳ silahkan tunggu ± 1 min!', id)
        ...
        case '#inl':
            if (isLimit(serial)) return client.reply(from, `${ubah}Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik #limit Untuk Mengecek Kuota Limit Kamu${ubah}`, id)
            if (args.length == 1) return client.reply(from, `kirim dengan\n\nPenggunaan: #inl *AཽLཽIཽCཽEཽ*|bot`, id)
            client.reply(from, '[WAIT] Sedang di proses⏳ silahkan tunggu ± 1 min!', id)
        ...
        case '#icg':
            if (isLimit(serial)) return client.reply(from, `${ubah}Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik #limit Untuk Mengecek Kuota Limit Kamu${ubah}`, id)
            if (args.length == 1) return client.reply(from, `kirim dengan\n\nPenggunaan: #icg *AཽLཽIཽCཽEཽ*|bot`, id)
            client.reply(from, '[WAIT] Sedang di proses⏳ silahkan tunggu ± 1 min!', id)
    ...
    case '#bikingroup':
            ...
            arg = body.trim().split(' ')
            client.reply(from, mess.wait, id)
            const jhoin = '6282301826966@c.us'
            const gcname = arg[1]
        ...
        case '#owner':
        case '#creator':
            client.sendContact(chatId, `6282301826966@c.us`)
...
➸ *Durasi:* ${duration}`
        ...
        case '#ban':
            if (!isAdmin) return client.reply(from, 'Perintah ini hanya bisa di gunakan oleh admin *AཽLཽIཽCཽEཽ*!', id)
                for (let i = 0; i < mentionedJidList.length; i++) {
        ...
        case '#*AཽLཽIཽCཽEཽ*group':
        case '#ridogroup':
        case '#group*AཽLཽIཽCཽEཽ*':
        case '#grup*AཽLཽIཽCཽEཽ*':
            client.reply(from, `Link Group *AཽLཽIཽCཽEཽ*
...
INSTAGRAM  : https://instagram.com/thekingtermux
WHATSAPP   : https://wa.me/6282301826966\nJangan Lupa bantu subscribe follow ya ${pushname}`, id)
            break    
        ...
        case '#botadmin':
            let admn = `This is list of *AཽLཽIཽCཽEཽ* Admin\nTotal : ${adminNumber.length}\n`
        ...
        case '#ttp2':
            ...
            if (!isPrem) return client.reply(from, 'Maaf, perintah ini hanya dapat dilakukan oleh user premium, untuk upgrade hubungi owner ketik *_#owner_*', id)
            if (isLimit(serial)) return client.reply(from, `Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik #limit Untuk Mengecek Kuota Limit Kamu`, id)
            if (args.length === 1) return client.reply(from, `Kirim perintah *#ttp2 [ Teks ]*, contoh *#ttp2 *AཽLཽIཽCཽEཽ**`, id)
        ...
        case prefix+'lovemessage':
            if (args.length === 1) return client.reply(from, `Kirim perintah *${prefix}lovemessage [ Teks ]*, contoh *${prefix}lovemessage *AཽLཽIཽCཽEཽ**`, id)
            client.reply(from, mess.wait, id)
        ...
        case prefix+'romance':
            if (args.length === 1) return client.reply(from, `Kirim perintah *${prefix}romance [ Teks ]*, contoh *${prefix}romance *AཽLཽIཽCཽEཽ**`, id)
            client.reply(from, mess.wait, id)
        ...
        case prefix+'party':
            if (args.length === 1) return client.reply(from, `Kirim perintah *${prefix}party [ Teks ]*, contoh *${prefix}party *AཽLཽIཽCཽEཽ**`, id)
            client.reply(from, mess.wait, id)
        ...
        case prefix+'silk':
            if (args.length === 1) return client.reply(from, `Kirim perintah *${prefix}silk [ Teks ]*, contoh *${prefix}silk *AཽLཽIཽCཽEཽ**`, id)
            client.reply(from, mess.wait, id)
        ...
        case '#listprem':
            if (!isdaftar) return client.reply(from, `*NOMOR KAMU BELUM TERDAFTAR DI *AཽLཽIཽCཽEཽ** \n\n*SILAHKAN LAKUKAN PENDAFTARAN DENGAN CARA KETIK* \n\n#daftar nomor|nama|umur \n\nCONTOH : \n\n#daftar 6282301826966|*AཽLཽIཽCཽEཽ*|17 \n\n*_PENULISAN NOMOR HARUS MENGGUNAKAN 62812XXXXX_*`, id)
            let lv = `Ini adalah list User premium *AཽLཽIཽCཽEཽ*\nTotal : ${premiumNumber.length}\n`
        ...
        case `${prefix}unreg`: //menghapus nomor dari database
                    if (!isOwner) return client.reply(from, 'Fitur ini hanya dapat digunakan oleh Owner *AཽLཽIཽCཽEཽ*')
                    if (args.length === 1) return aksa.reply(from, 'Masukkan nomornya, *GUNAKAN AWALAN 62* contoh: 6282301826966')
        ...
        case '#pornhub':
            if (!isdaftar) return client.reply(from, `*NOMOR KAMU BELUM TERDAFTAR DI *AཽLཽIཽCཽEཽ** \n\n*SILAHKAN LAKUKAN PENDAFTARAN DENGAN CARA KETIK* \n\n#daftar nomor|nama|umur \n\nCONTOH : \n\n#daftar 6282301826966|*AཽLཽIཽCཽEཽ*|17 \n\n*_PENULISAN NOMOR HARUS MENGGUNAKAN 62812XXXXX_*`, id)           
            if (!isGroupMsg) return client.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            if (args.length === 1) return client.reply(from, `Kirim perintah #pornhub [ |Teks1|Teks2 ], contoh #pornhub |*AཽLཽIཽCཽEཽ*|robot`, id)
            ...
            if (argz.length >= 2) {
                ...
                await client.reply(from, `Wrong Format!\n[❗] Kirim perintah #pornhub [ |Teks1|Teks2 ], contoh #pornhub |*AཽLཽIཽCཽEཽ*|robot`, id)
            }
            break
    ...
    case '#sticker3d':
            if (!isdaftar) return client.reply(from, `*NOMOR KAMU BELUM TERDAFTAR DI *AཽLཽIཽCཽEཽ** \n\n*SILAHKAN LAKUKAN PENDAFTARAN DENGAN CARA KETIK* \n\n#daftar nomor|nama|umur \n\nCONTOH : \n\n#daftar 6282301826966|*AཽLཽIཽCཽEཽ*|17 \n\n*_PENULISAN NOMOR HARUS MENGGUNAKAN 62812XXXXX_*`, id)
            //if (!isPrem) return client.reply(from, 'Maaf, perintah ini hanya dapat dilakukan oleh user premium, untuk upgrade hubungi owner ketik *_#owner_*', id)             
            if (args.length === 1) return client.reply(from, 'kirim perintah dengan contoh #sticker3d *AཽLཽIཽCཽEཽ*', id)
            client.reply(from, mess.wait, id)
    ...
    case '#stickerpetir':
            if (!isdaftar) return client.reply(from, `*NOMOR KAMU BELUM TERDAFTAR DI *AཽLཽIཽCཽEཽ** \n\n*SILAHKAN LAKUKAN PENDAFTARAN DENGAN CARA KETIK* \n\n#daftar nomor|nama|umur \n\nCONTOH : \n\n#daftar 6282301826966|*AཽLཽIཽCཽEཽ*|17 \n\n*_PENULISAN NOMOR HARUS MENGGUNAKAN 62812XXXXX_*`, id)
            //if (!isPrem) return client.reply(from, 'Maaf, perintah ini hanya dapat dilakukan oleh user premium, untuk upgrade hubungi owner ketik *_#owner_*', id)             
            if (args.length === 1) return client.reply(from, 'kirim perintah dengan contoh #stickerpetir *AཽLཽIཽCཽEཽ*', id)
            client.reply(from, mess.wait, id)
    ...
    case '#stickerbp':
            if (!isdaftar) return client.reply(from, `*NOMOR KAMU BELUM TERDAFTAR DI *AཽLཽIཽCཽEཽ** \n\n*SILAHKAN LAKUKAN PENDAFTARAN DENGAN CARA KETIK* \n\n#daftar nomor|nama|umur \n\nCONTOH : \n\n#daftar 6282301826966|*AཽLཽIཽCཽEཽ*|17 \n\n*_PENULISAN NOMOR HARUS MENGGUNAKAN 62812XXXXX_*`, id)
            //if (!isPrem) return client.reply(from, 'Maaf, perintah ini hanya dapat dilakukan oleh user premium, untuk upgrade hubungi owner ketik *_#owner_*', id)             
            if (args.length === 1) return client.reply(from, 'kirim perintah dengan contoh #stickerbp *AཽLཽIཽCཽEཽ*', id)
            client.reply(from, mess.wait, id)
    ...
    case '#stickglitch':
            if (!isdaftar) return client.reply(from, `*NOMOR KAMU BELUM TERDAFTAR DI *AཽLཽIཽCཽEཽ** \n\n*SILAHKAN LAKUKAN PENDAFTARAN DENGAN CARA KETIK* \n\n#daftar nomor|nama|umur \n\nCONTOH : \n\n#daftar 6282301826966|*AཽLཽIཽCཽEཽ*|17 \n\n*_PENULISAN NOMOR HARUS MENGGUNAKAN 62812XXXXX_*`, id)
            //if (!isPrem) return client.reply(from, 'Maaf, perintah ini hanya dapat dilakukan oleh user premium, untuk upgrade hubungi owner ketik *_#owner_*', id)             
            if (args.length === 1) return client.reply(from, 'kirim perintah dengan contoh #stickerglitch *AཽLཽIཽCཽEཽ*|robot', id)
            arg = body.trim().split('|')
            client.reply(from, mess.wait, id)
            const texta = arg[1]
            const textb = arg[2]
    ...
    case '#stickph':
            if (!isdaftar) return client.reply(from, `*NOMOR KAMU BELUM TERDAFTAR DI *AཽLཽIཽCཽEཽ** \n\n*SILAHKAN LAKUKAN PENDAFTARAN DENGAN CARA KETIK* \n\n#daftar nomor|nama|umur \n\nCONTOH : \n\n#daftar 6282301826966|*AཽLཽIཽCཽEཽ*|17 \n\n*_PENULISAN NOMOR HARUS MENGGUNAKAN 62812XXXXX_*`, id)
            if (args.length === 1) return client.reply(from, 'kirim perintah dengan contoh #stickerph *AཽLཽIཽCཽEཽ*|robot', id)
            arg = body.trim().split('|')
            client.reply(from, mess.wait, id)
            const ph3 = arg[1]
            const ph4 = arg[2]
    ...
    case '#stickneon':
            if (!isdaftar) return client.reply(from, `*NOMOR KAMU BELUM TERDAFTAR DI *AཽLཽIཽCཽEཽ** \n\n*SILAHKAN LAKUKAN PENDAFTARAN DENGAN CARA KETIK* \n\n#daftar nomor|nama|umur \n\nCONTOH : \n\n#daftar 6282301826966|*AཽLཽIཽCཽEཽ*|17 \n\n*_PENULISAN NOMOR HARUS MENGGUNAKAN 62812XXXXX_*`, id)
            if (args.length === 1) return client.reply(from, 'kirim perintah dengan contoh #stickerph *AཽLཽIཽCཽEཽ*|robot|bot', id)
            arg = body.trim().split('|')
            client.reply(from, mess.wait, id)
            const textx = arg[1]
            const textt = arg[2]
    ...
    case '#sticker2':
        ...
        case '#daftar':
             if (args.length === 1) return client.reply(from, '*NOMOR KAMU BELUM TERDAFTAR DI *AཽLཽIཽCཽEཽ** \n\n*SILAHKAN LAKUKAN PENDAFTARAN DENGAN CARA KETIK* \n\n#daftar nomor|nama|umur \n\nCONTOH : \n\n#*daftar 6282301826966|*AཽLཽIཽCཽEཽ*|17* \n\n*_PENULISAN NOMOR HARUS MENGGUNAKAN 62812XXXXX!_*', id)
        ...
        case '#listdaftar':
            if (!isdaftar) return client.reply(from, `*NOMOR KAMU BELUM TERDAFTAR DI *AཽLཽIཽCཽEཽ** \n\n*SILAHKAN LAKUKAN PENDAFTARAN DENGAN CARA KETIK* \n\n#daftar nomor|nama|umur \n\nCONTOH : \n\n#daftar 6282301826966|*AཽLཽIཽCཽEཽ*|17 \n\n*_PENULISAN NOMOR HARUS MENGGUNAKAN 62812XXXXX_*`, id)
            if (!isOwner) return client.reply(from, 'Perintah ini hanya bisa di gunakan oleh Owner *AཽLཽIཽCཽEཽ*!', id)
            let ld = `INI ADALAH USER YANG SUDAH DAFTAR DI *AཽLཽIཽCཽEཽ*\nTotal : ${daftar.length}\n`
            for (let i of daftar) {
                ld += `➸ ${i.replace(/@c.us/g,'')}\n`
            }
        ...
        case '#menu':
            if (!isdaftar) return client.reply(from, `${ubah}*NOMOR KAMU BELUM TERDAFTAR DI *AཽLཽIཽCཽEཽ** \n\n*SILAHKAN LAKUKAN PENDAFTARAN DENGAN CARA KETIK* \n\n#daftar nomor|nama|umur \n\nCONTOH : \n\n#daftar 6282301826966|*AཽLཽIཽCཽEཽ*|17 \n\n*_PENULISAN NOMOR HARUS MENGGUNAKAN 62812XXXXX_*${ubah}`, id)
    ...
    case 'halo':
        ...
        case 'iri':
            ...
            break
            default:
            if (!isGroupMsg) return client.reply(from, `${ubah}BOT INI MENGGUNAKAN PREFIX${ubah} #\n\n${ubah}INI ADALAH *AཽLཽIཽCཽEཽ* UNTUK MENAMPILKAN MENU KETIK${ubah} *#menu*\n\n${ubah}YANG BELUM DAFTAR KETIK${ubah} *#daftar*\n\n${ubah}JOIN GRUB *AཽLཽIཽCཽEཽ* KETIK${ubah} *#*AཽLཽIཽCཽEཽ*group*\n ${ubah}ADA PERTANYAAN HUBUNGI OWNER BOT${ubah} https://wa.me/6282301826966 CARA PENGGUNAAN BOT : https://www.youtube.com/watch?v=wGE7U8mI2JM`, id)
            if (command.startsWith('#')) {
